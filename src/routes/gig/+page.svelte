<section class="bg-[#46cdff] h-[65vh] text-white flex flex-col items-center text-center p-12 sm:px-[30%] sm:justify-center">
    ...
    <h1 class="mt-12 text-3xl sm:text-[3rem] sm:leading-tight font-bold">Yeah, that's you!</h1>
    <br class="my-10">
    <button class="bg-black text-xl text-white font-semibold rounded-xl px-10 py-4">
        Apply Now
    </button>
...
<section class="bg-white h-screen text-black p-2 flex flex-row">
    ...
    <div class="flex flex-col w-96 space-y-6">
        <div class="flex space-x-6">
            <div class="bg-gray-200 w-48 h-48 rounded-2xl">
                top 1
            </div>
            <div class="bg-gray-200 w-48 h-48 rounded-2xl">
                top 2
        ...
        <div class="bg-gray-200 h-48 rounded-2xl">
            bottom
        </div>
    </div>
